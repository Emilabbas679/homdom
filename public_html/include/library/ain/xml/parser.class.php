 ...
 * <code>
 * $aXmlData = AIN::getLib('xml.parser')->parse($sXml);
 * </code>
 * 
...
class AIN_Xml_Parser
{
	...
	*/
	...
	/**
	 * @return AIN_Xml_Parser
	 */
	public static function instance() {
		return AIN::getLib('xml.parser');
	}
	...
	public function parse($mFile, $sEncoding = 'ISO-8859-1', $bEmptyData = true)
	{
		...
		{			
			...
			return AIN_Error::trigger($this->errorString(), E_USER_ERROR);
		}
	...
	private function _handleElementStart(&$oParser, $sName, $aAttributes)
	{
		...
		foreach ($aAttributes AS $sKey => $sValue)
		{
			...
			{
				$aAttributes[$sKey] = AIN::getLib('parse.format')->unhtmlspecialchars($sValue);
			}
		}
