...
class AIN_Pager
{
	...
	public function set($aParams = array())
	{
        ...
        {
        	$this->_aParams = array_merge(AIN_Request::instance()->getRequests(), $aParams['aParams']);
        }
        else 
        {
        	$this->_aParams = AIN_Request::instance()->getRequests();
        }    
    ...
    private function _getInfo()
    {
		    ...
		    if ($this->_iPage != 1)
		    {
			   ...
			   AIN::getLib('template')->setHeader('<link rel="prev" href="' . $aInfo['prevUrl'] . '" />');
		    }
		    ...
		    if ($this->_iPagesCount != $this->_iPage)
		    {
			    ...
			    AIN::getLib('template')->setHeader('<link rel="next" href="' . $aInfo['nextUrl'] . '" />');
