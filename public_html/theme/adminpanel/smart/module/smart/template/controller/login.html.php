                    ...
                    <div class="lp-content">
                        ...
                        <div class="lp-col">
                            <div class="lp-right">
                                ...
                                <div class="lp-form">
                                    <form method="post" action="{url link='advertiser.login'}">
                                        ...
                                        <div class="inp-bottom">
                                            <div class="lp-check">
                                                ...
                                                <label for="check">{phrase var='user.remember_me'}</label>
                                            </div>
                                            <div class="forget">
                                                <a href="{url link='advertiser.password'}">{phrase var='user.reset_password'}</a>
                                            </div>
                                        </div>
