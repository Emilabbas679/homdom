					...
					<div class="lp-content">
						<div class="lp-col">
							<div class="lp-left">
								...
								<div class="lp-a">{phrase var='adnetwork.advertiser_title'}</div>
								<div class="lp-b">
						...
						<div class="lp-col">
							<div class="lp-right for-reg">
								...
								<div class="lp-form">
									...
									{else}
									<form action="{url link='advertiser.register'}" METHOD="POST" id="register-form">
								...
								<div class="lp-bt">
									<div class="lp-block">
										...
										<div class="lp-r"><a href="{url link='advertiser.login'}">{phrase var='adnetwork.login'}</a></div>
									</div>
								</div>
							</div>
						</div>
