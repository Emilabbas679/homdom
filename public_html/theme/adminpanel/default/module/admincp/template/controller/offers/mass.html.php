    ...
    <div class="a-block a-center">
        ...
        <div class="a-block-body">
            <div class="form form-horizontal result">
                ...
                <form action="{{ url link='offers.mass' }}" method="POST"  enctype="multipart/form-data">
                    ...
                    <div class="resident_complex_container">
                        <?php foreach ($aForms['offer_ids'] as $id){ ?>
                            <input type="hidden" name="val[offer_ids][]" value="<?=$id?>">
                        <?php } ?>
                        ...
                        <div class="add_row">
                            <div class="add_col col_2 home_check_buy_sell">
                                <label class="label_item radio_btn">
                                    <input type="radio" name="val[offer_type]" value='1'>
                            ...
                            <div class="add_col col_2 home_check_buy_sell" >
                                <label class="label_item radio_btn">
                                    <input type="radio" name="val[offer_type]" value='2' >
                                    <div class="check_item itm_catg ch_hm_validate">
                            ...
                            <div class="add_col col_5">
                                <div class="add_check_items static ck_build_type">
                                    <label class="add_check">
                                        <input type="radio" name="val[building_type]" value='1' id="building_type_1">
                                        <span>{{ phrase var="homdom.building_type_1" }} </span>
                                    </label>
                                </div>
                                <div class="add_check_items static ck_build_type">
                                    <label class="add_check">
                                        <input type="radio" name="val[building_type]" value='0' id="building_type_0">
                            ...
                            <div class="add_col col_5">
                                <div class="add_search">
                                    <div class="custom_select2">
                                        ...
                                        <select class="form-control select_2_autocomplete valid_slct_1" id="buildings" name="val[building_id]">
                        ...
                        <div class="add_col col_1 item_lbl_child_1">
                            ...
                            <div class="add_col col_5">
                                <div class="add_inp_number static">
                                    <input type="text" min="1" name="val[built_year]" id="built_year"  class="built_year integer_num" placeholder="" maxlength="4">
                                    <span class="clear_inp_val"></span>
                                    <div class="alert alert-danger alert-block">
                                        <button type="button" class="hide_error" data-dismiss="alert">x</button>
                                        <span>{{ phrase var='homdom.enter' }}</span>
                        ...
                        <div class="add_col col_1 item_lbl_child_1">
                            ...
                            <div class="add_col col_5">
                                <div class="add_inp_number static">
                                    <input type="text" min="1" name="val[ceiling_height]" id="ceiling_height" class="ceiling_height decimal rpl_input_val"  placeholder="" maxlength="5">
                                    <span class="clear_inp_val"></span>
                                    <div class="alert alert-danger alert-block">
                                        <button type="button" class="hide_error" data-dismiss="alert">x</button>
                                        <span>{{ phrase var='homdom.enter' }}</span>
                        ...
                        <div class="add_col col_1 item_lbl_child_1">
                            ...
                            <div class="add_col col_5">
                                <div class="add_check_items static ck_parking_type">
                                    <label class="add_check">
                                        <input type="radio" name="val[parking]" id="parking" value='0' >
                                        <span> {{ phrase var="homdom.no" }} </span>
                                    </label>
                                </div>
                                <div class="add_check_items static ck_parking_type">
                                    <label class="add_check">
                                        <input type="radio" name="val[parking]" value="1" id="parking_1" >
                                        <span>{{ phrase var="homdom.close" }}  </span>
                                    </label>
                                </div>
                                <div class="add_check_items static ck_parking_type">
                                    <label class="add_check">
                                        <input type="radio" name="val[parking]" id="parking_2" value="2" >
                                        <span>{{ phrase var="homdom.underground" }}  </span>
                                    </label>
                                </div>
                                <div class="add_check_items static ck_parking_type">
                                    <label class="add_check">
                                        <input type="radio" name="val[parking]" id="parking_3"  value="3" >
                            ...
                            <div class="add_col col_5">
                                <div class="add_check_items static">
                                    <label class="add_inp_check_static check_lift">
                                        <input type="checkbox" name="val[lift][]"  value="1" placeholder="">
                                        <span>{{ phrase var='homdom.lift_1' }}</span>
                                    </label>
                                </div>
                                <div class="add_check_items static ck_lift_type check_lift_same">
                                    <label class="add_check">
                                        <input type="checkbox" name="val[lift][]" id="2" value="2">
                                        <span>{{ phrase var='homdom.passenger_lift' }}</span>
                                    </label>
                                </div>
                                <div class="add_check_items static ck_lift_type check_lift_same">
                                    <label class="add_check">
                                        <input type="checkbox" name="val[lift][]"   value='3'>
                        ...
                        <div class="add_col col_1">
                            ...
                            <div class="add_col col_5">
                                <div class="add_check_items static ck_build_sanitary">
                                    <label class="add_check">
                                        <input type="radio" name="val[sanitary]"  value="1">
                                ...
                                <div class="add_check_items static ck_build_sanitary">
                                    <label class="add_check">
                                        <input type="radio" name="val[sanitary]"  value="2" >
                                ...
                                <div class="add_check_items static ck_build_sanitary">
                                    <label class="add_check">
                                        <input type="radio" name="val[sanitary]"  value="3"  >
                        ...
                        <div class="add_col col_1 ">
                            ...
                            <div class="add_col col_5">
                                <div class="add_check_items static ck_build_balcony">
                                    <label class="add_check">
                                        <input type="radio" name="val[balcony]" value="0"  >
                                        <span> {{ phrase var='homdom.no' }} </span>
                                        <div class="alert alert-danger alert-block">
                                            <button type="button" class="hide_error" data-dismiss="alert">x</button>
                                            <span>{{ phrase var='homdom.enter' }}</span>
                                ...
                                <div class="add_check_items static ck_build_balcony">
                                    <label class="add_check">
                                        <input type="radio"name="val[balcony]" value="1" >
                                ...
                                <div class="add_check_items static ck_build_balcony">
                                    <label class="add_check">
                                        <input type="radio" name="val[balcony]" value="2" >
                        ...
                        <div class="add_col col_1">
                            ...
                            <div class="add_col col_5">
                                <div class="add_check_items static ck_build_quality">
                                    <label class="add_check">
                                        <input type="radio" name="val[quality]" value="0"   >
                                ...
                                <div class="add_check_items static ck_build_quality">
                                    <label class="add_check">
                                        <input type="radio" name="val[quality]" value="1" >
                                ...
                                <div class="add_check_items static ck_build_quality">
                                    <label class="add_check">
                                        <input type="radio" name="val[quality]" value="2"   >
                                ...
                                <div class="add_check_items static ck_build_quality">
                                    <label class="add_check">
                                        <input type="radio" name="val[quality]" value="3"  >
                                ...
                                <div class="add_check_items static ck_build_quality">
                                    <label class="add_check">
                                        <input type="radio" name="val[quality]" value="4"    >
                        ...
                        <div class="add_col col_1">
                            ...
                            <div class="add_col col_5">
                                <div class="add_check_items static ck_build_window_view">
                                    <label class="add_check">
                                        <input type="checkbox" name="val[window_view][]" value="1"    >
                                        <span> {{ phrase var='homdom.window_view_1' }} </span>
                                    </label>
                                </div>
                                <div class="add_check_items static ck_build_window_view">
                                    <label class="add_check">
                                        <input type="checkbox" name="val[window_view][]" value="2"   >
                        ...
                        <div class="add_col col_1">
                            ...
                            <div class="add_col col_5">
                                <div class="add_check_items static ck_build_bill_of_sale">
                                    <label class="add_check">
                                        <input type="radio" name="val[bill_of_sale]" value="1"  >
                                        <span>{{ phrase var='homdom.bill_of_sale_1' }} </span>
                                    </label>
                                </div>
                                <div class="add_check_items static ck_build_bill_of_sale">
                                    <label class="add_check">
                                        <input type="radio"  name="val[bill_of_sale]"  value="0" >
                        ...
                        <div class="add_row item_lbl_child_1">
                            ...
                            <div class="add_col col_1 ">
                                <?php foreach ($this->_aVars['utilityRows'] as $key=>$val) { ?>
                            ...
                            <div class="add_col col_1">
                                ...
                                <div class="add_col col_5">
                                    <div class="add_inp_number">
                                        <input type="number"  name="val[price]"  placeholder="" class="decimal" maxlength="13">
                                        <span class="clear_inp_val"></span>
                                        <div class="alert alert-danger alert-block">
                                            <button type="button" class="hide_error" data-dismiss="alert">x</button>
                            ...
                            <div class="add_col col_1">
                                ...
                                <div class="add_col col_5">
                                    <div class="add_check_items static ck_build_mortgage">
                                        <label class="add_check">
                                            <input type="radio" name="val[mortgage]"  value="1" >
                                    ...
                                    <div class="add_check_items static ck_build_mortgage">
                                        <label class="add_check">
                                            <input type="radio" name="val[mortgage]"   value="0">
                            ...
                            <div class="add_col col_1">
                                ...
                                <div class="add_col col_5">
                                    <div class="add_check_items static ck_build_haggle">
                                        <label class="add_check">
                                            <input type="radio" name="val[haggle]"  value="1" >
                                    ...
                                    <div class="add_check_items static ck_build_haggle">
                                        <label class="add_check">
                                            <input type="radio" name="val[haggle]"   value="0" >
...
<script>
    var massType = $("#mass_type").val()


    $("#mass_type").change(function (){
        // console.log(massSettings($(this)).val())
    })

    // massSettings()
    function massSettings(massType='targets')
    {
        $("#loading").show();
        $("#massData").html('');
        $.ajax({
            url: "/_ajax?core[ajax]=true&core[call]=admincp.massSettings",
            data: {'massType': massType,'url': window.location.href},
...
<link href="/theme/frontend/homdom/style/filepond/filepond-plugin-media-preview.css" rel="stylesheet">
<link href="/theme/frontend/homdom/style/filepond/filepond.css" rel="stylesheet">
