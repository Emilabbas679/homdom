<div class="content-inner">
    <div class="breadcrumb">
        <ul>
            <li><a href="/">{{phrase var="homdom.home"}}</a></li>
            <li><span>{{phrase var="homdom.localities"}}</span></li>
        </ul>
    </div>
    ...
    <div class="a-block">
        <div class="a-block-head">
            <span class="breadcrumb-item active">{{phrase var="homdom.localities"}}</span>
            <a href="{{url link='location.locality.add'}}" class="a-button b-gr f-right with-icon add b-small"><i class="icon-add mr-1"></i>{{phrase var='homdom.add'}}</a>
            <div class="match_sect">
                <form action="{{ url link='location.locality.mass' }}">
                    <div id="mass_ids">
            ...
            <div class="table-responsive">
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td>
                            {{ if $tId == 'ID' }}
                            <input type="checkbox" class="ids" value="{{$tbodyRow}}" id="id_{{$tbodyRow}}">
...
<script>
    ...
    function addIdsToForm(sList)
    {
        ...
        for (let i=0; i<sList.length; i++){
            $("#mass_ids").append('<input type="hidden" name="ids[]" value="'+sList[i]+'">')
        }
