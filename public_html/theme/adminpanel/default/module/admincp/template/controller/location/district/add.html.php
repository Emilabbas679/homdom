<div class="content-inner">
    <div class="breadcrumb">
        <ul>
            ...
            <li><a href="{{url link='location.district.index'}}">{{phrase var='homdom.districts'}}</a></li>
            <li><span>{{phrase var='homdom.district_add'}}</span></li>
        </ul>
    </div>
    <div class="a-block a-center">
        ...
        <div class="a-block-body">
            <div class="form form-horizontal result">
                {{error}}
                <form action="{{url link='location.district.add' id=$aForms.id}}" method="POST" id="apanel_agency_add">
