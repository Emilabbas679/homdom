<div class="content-inner">
    <div class="breadcrumb">
        <ul>
            ...
            <li><span>{{phrase var="homdom.types"}}</span></li>
        </ul>
    </div>
    ...
    <div class="a-block">
        <div class="a-block-head">
            <span class="breadcrumb-item active">{{phrase var="homdom.types"}}</span>
            <a href="{{url link='offer.type.add'}}" class="a-button b-gr f-right with-icon add b-small"><i class="icon-add mr-1"></i>{{phrase var='homdom.add'}}</a>
        </div>
        <div class="a-block-body">
