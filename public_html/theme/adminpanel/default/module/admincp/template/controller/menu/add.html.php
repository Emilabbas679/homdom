<div class="content-inner">
    <div class="breadcrumb">
        <ul>
            ...
            <li><a href="{{url link='menu.index'}}">{{phrase var='homdom.menu'}}</a></li>
    ...
    <div class="a-block a-center">
        ...
        <div class="a-block-body">
            <div class="form form-horizontal result">
                {{error}}
                <form action="{{url link='menu.add' id=$aForms.id}}" method="POST" id="apanel_agency_add" enctype="multipart/form-data">
