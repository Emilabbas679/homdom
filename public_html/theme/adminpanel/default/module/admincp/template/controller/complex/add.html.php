    ...
    <div class="a-block a-center">
        ...
        <div class="a-block-body">
            <div class="form form-horizontal result">
                ...
                <form action="/complex/add?id=<?=$id?>" method="POST"  enctype="multipart/form-data">
                    ...
                    <div class="resident_complex_container">
                        ...
                        <div class="wrap_body">
                            ...
                            <div class="add_row">
                                ...
                                <div class="form-group">
                                    <label class="form-label" for="u-number">{{phrase var='homdom.name'}}</label>
                                    <div class="form-input">
                                        <input id="name" class="name" value="<?= AIN::getService('homdom.helpers')->getValueOfInput($aForms, 'name')?>" name="val[name]" type="text" placeholder="{{phrase var='homdom.name'}}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label class="form-label" for="u-number">{{phrase var='homdom.phone'}}</label>
                                    <div class="form-input">
                                        <input id="phone" class="phone" value="<?= AIN::getService('homdom.helpers')->getValueOfInput($aForms, 'phone')?>" name="val[phone]" type="text" placeholder="{{phrase var='homdom.phone'}}">
                                    </div>
                                </div>


                                <div class="form-group">
                                    <label class="form-label" for="u-number">{{phrase var='homdom.organization'}}</label>
                                    <div class="form-input">
                                        <input id="organization" class="organization" value="<?= AIN::getService('homdom.helpers')->getValueOfInput($aForms, 'organization')?>" name="val[organization]" type="text" placeholder="{{phrase var='homdom.organization'}}">
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label class="form-label" for="u-number">{{phrase var='homdom.url'}}</label>
                                    <div class="form-input">
                                        <input id="url" class="url" value="<?= AIN::getService('homdom.helpers')->getValueOfInput($aForms, 'url')?>" name="val[url]" type="text" placeholder="{{phrase var='homdom.url'}}">
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label class="form-label" for="u-number">{{phrase var='homdom.email'}}</label>
                                    <div class="form-input">
                                        <input id="email" class="email" value="<?= AIN::getService('homdom.helpers')->getValueOfInput($aForms, 'email')?>" name="val[email]" type="text" placeholder="{{phrase var='homdom.email'}}">
                                    </div>
                                </div>


                                <div class="form-group">
                                    <label class="form-label" for="u-number">{{phrase var='homdom.price'}}</label>
                                    <div class="form-input">
                                        <input id="price" class="price" value="<?= AIN::getService('homdom.helpers')->getValueOfInput($aForms, 'price')?>" name="val[price]" type="number" placeholder="{{phrase var='homdom.price'}}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group" id="city_block">
                                    <label class="form-label" for="u-number">{{phrase var='homdom.city'}}</label>
                        ...
                        <div class="add_row added_all_galery_foto">
                            <div class="add_head"> {{ phrase var='homdom.logo' }} </div>
                            <div class="add_litle_info">
                                {{ phrase var='homdom.logo_detail' }}
                            </div>
                            <div class="add_col col_1">
                                <div class="add_img_gallery">
                                    <?php if(isset($aForms['logo']) and $aForms['logo'] != '') { ?>
                                            <a href="<?=$aForms['logo']?>" data-fancybox="gallery" data-caption="" data-id="<?=$aForms['logo']?>" class="add_galery_items">
                                                <img src="<?=$aForms['logo']?>" alt="" />
                                            </a>
                                    <?php } ?>
                                </div>
                            </div>
                            ...
                            <div class="add_col col_1">
                                <div class="lg_input">
                                    ...
                                    <input type="hidden" id="logo" name="val[logo]" <?php if (isset($aForms['logo']) and $aForms['logo'] != '') { ?>  value="<?=$aForms['logo']?>" <?php } ?>>
                                </div>
                            </div>

                        </div>
                        <div class="add_row added_all_galery_foto">
                            <div class="add_head"> {{ phrase var='homdom.cover_photo' }} </div>
                            <div class="add_litle_info">
                                {{ phrase var='homdom.cover_photo_detail' }}
                            </div>
                            <div class="add_col col_1">
                                <div class="add_img_gallery">
                                    <?php if(isset($aForms['cover_photo']) and $aForms['cover_photo'] != '') { ?>
                                            <a href="<?=$aForms['cover_photo']?>" data-fancybox="gallery" data-caption="" data-id="<?=$aForms['cover_photo']?>" class="add_galery_items">
                                                <img src="<?=$aForms['cover_photo']?>" alt="" />
                                            </a>
                                    <?php } ?>
                                </div>
                            </div>
                            ...
                            <div class="add_col col_1">
                                <div class="lg_input">
                                    <input type="file" name="image" class="cover_photo">
                                    <input type="hidden" id="cover_photo" name="val[cover_photo]" <?php if (isset($aForms['cover_photo']) and $aForms['cover_photo'] != '') { ?>  value="<?=$aForms['cover_photo']?>" <?php } ?>>
                                </div>
                            </div>
