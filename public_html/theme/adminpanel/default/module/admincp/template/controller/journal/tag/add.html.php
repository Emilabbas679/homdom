<div class="content-inner">
    <div class="breadcrumb">
        <ul>
            ...
            <li><span>{{phrase var='homdom.tag_add'}}</span></li>
        </ul>
    </div>
    <div class="a-block a-center">
        <div class="a-block-head">{{phrase var='homdom.tag_add'}}</div>
        <div class="a-block-body">
            <div class="form form-horizontal result">
                {{error}}
                <form action="{{url link='journal.tag.add' id=$aForms.id}}" method="POST" id="apanel_agency_add">
