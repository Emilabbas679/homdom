<div class="content-inner">
    <div class="breadcrumb">
        <ul>
            ...
            <li><a href="{{url link='journal.tag.index'}}">{{phrase var='homdom.metros'}}</a></li>
            <li><span>{{phrase var='homdom.metro_add'}}</span></li>
        </ul>
    </div>
    <div class="a-block a-center">
        <div class="a-block-head">{{phrase var='homdom.metro_add'}}</div>
        <div class="a-block-body">
            <div class="form form-horizontal result">
                {{error}}
                <form action="{{url link='location.metro.add' id=$aForms.id}}" method="POST" id="apanel_agency_add">
