<div class="content-inner">
    <div class="breadcrumb">
        <ul>
            ...
            <li><span>{{phrase var="homdom.pages"}}</span></li>
        </ul>
    </div>
    ...
    <div class="a-block">
        <div class="a-block-head">
            ...
            <a href="{{url link='static_page.add'}}" class="a-button b-gr f-right with-icon add b-small"><i class="icon-add mr-1"></i>{{phrase var='homdom.add'}}</a>
        </div>
        <div class="a-block-body">
