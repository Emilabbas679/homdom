...
<div class="content-inner">
    <div class="breadcrumb">
        <ul>
            ...
            <li><span>{{phrase var='homdom.room_add'}}</span></li>
        </ul>
    </div>
    <div class="a-block a-center">
        <div class="a-block-head">{{phrase var='homdom.room_add'}}</div>
        <div class="a-block-body">
            <div class="form form-horizontal result">
                <?php if (isset($aForms['id'])){$id = $aForms['id'];} else {$id = 0;} ?>
                <form action="/complex-room/add?id=<?=$id?>" method="POST"  enctype="multipart/form-data">
                    ...
                    <div class="resident_complex_container">
                        ...
                        <div class="wrap_body">
                            ...
                            <div class="add_row">
                                ...
                                <div class="form-group" id="city_block">
                                    <label class="form-label" for="u-number">{{phrase var='homdom.complex'}}</label>
                                    <div class="custom_select2">
                                        <select class="form-control select_2_autocomplete" name="val[complex_id]" id="complexes" style="100%">
                                            <?php if (isset($aForms['complex_id']) and $aForms['complex_id'] != '' and $aForms['complex_id'] != '0') {
                                                ...
                                                if ($getComplex){ ?>
                                                    <option value="<?=$aForms['complex_id'] ?>"><?=$getComplex['name']?></option>
                                                <?php }} ?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label class="form-label" for="u-number">{{phrase var='homdom.room_count'}}</label>
                                    <div class="form-input">
                                        <input id="room_count"  value="<?= AIN::getService('homdom.helpers')->getValueOfInput($aForms, 'room_count')?>" name="val[room_count]" type="number" placeholder="{{phrase var='homdom.room_count'}}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-input">
                                        <input id="price" class="decimal" value="<?= AIN::getService('homdom.helpers')->getValueOfInput($aForms, 'price')?>" name="val[price]" type="text" placeholder="{{phrase var='homdom.price'}}">
                                    </div>
                                </div>


                                <div class="form-group">
                                    <label class="form-label" for="u-number">{{phrase var='homdom.area'}}</label>
                                    <div class="form-input">
                                        <input id="area" class="decimal" value="<?= AIN::getService('homdom.helpers')->getValueOfInput($aForms, 'area')?>" name="val[area]" type="text" placeholder="{{phrase var='homdom.area'}}">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="add_row added_all_galery_foto">
                            <div class="add_head"> {{ phrase var='homdom.image' }} </div>
                            <div class="add_litle_info">
                                {{ phrase var='homdom.logo_detail' }}
                            </div>
                            <div class="add_col col_1">
                                <div class="add_img_gallery">
                                    <?php if(isset($aForms['image']) and $aForms['image'] != '') { ?>
                                        <a href="<?=$aForms['image']?>" data-fancybox="gallery" data-caption="" data-id="<?=$aForms['image']?>" class="add_galery_items">
                                            <img src="<?=$aForms['image']?>" alt="" />
                                        </a>
                                    <?php } ?>
                                </div>
                            </div>
                            ...
                            <div class="add_col col_1">
                                <div class="lg_input">
                                    ...
                                    <input type="hidden" id="image" name="val[image]" <?php if (isset($aForms['image']) and $aForms['image'] != '') { ?>  value="<?=$aForms['image']?>" <?php } ?>>
                                </div>
                            </div>
