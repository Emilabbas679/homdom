<div class="content-inner">
    <div class="breadcrumb">
        <ul>
            ...
            <li><a href="{{url link='translation.index'}}">{{phrase var='homdom.translations'}}</a></li>
            <li><span>{{phrase var='homdom.translation_add'}}</span></li>
        </ul>
    </div>
    <div class="a-block a-center">
        <div class="a-block-head">{{phrase var='homdom.translation_add'}}</div>
        <div class="a-block-body">
            <div class="form form-horizontal result">
                {{error}}
                <form action="{{url link='translation.add' id=$aForms.id}}" method="POST" id="apanel_agency_add" enctype="multipart/form-data">
