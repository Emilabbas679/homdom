<div class="content-inner">
    <div class="breadcrumb">
        <ul>
            ...
            <li><a href="{{url link='faq.complex.index'}}">{{phrase var='homdom.faq'}}</a></li>
            <li><span>{{phrase var='homdom.add'}}</span></li>
        </ul>
    </div>
    <div class="a-block a-center">
        <div class="a-block-head">{{phrase var='homdom.faq_add'}}</div>
        <div class="a-block-body">
            <div class="form form-horizontal result">
                {{error}}
                <form action="{{url link='faq.complex.add' id=$aForms.id}}" method="POST" id="apanel_agency_add" enctype="multipart/form-data">
