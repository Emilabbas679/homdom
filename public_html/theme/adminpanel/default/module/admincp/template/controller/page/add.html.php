<div class="content-inner">
    <div class="breadcrumb">
        <ul>
            ...
            <li><a href="{{url link='page.index'}}">{{phrase var='homdom.pages'}}</a></li>
            <li><span>{{phrase var='homdom.ass'}}</span></li>
        </ul>
    </div>
    <div class="a-block a-center">
        ...
        <div class="a-block-body">
            <div class="form form-horizontal result">
                {{error}}
                <form action="{{url link='page.add' id=$aForms.id}}" method="POST" id="apanel_agency_add" enctype="multipart/form-data">
