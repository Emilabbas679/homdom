...
<div class="search">
    <form class="simple_form search-form js-search-form" id="new_q"  action="<?php echo AIN::getLib('url')->makeUrl('offers'); ?>" method="get">
                    ...
                    <div class="add_col  p_10">
                        <div class="add_col col_2 select_city_data  p_0" >
                            <select class="js-example-basic-single " name="offer_type">
                                <option  value="0" <?=AIN::getService('homdom.helpers')->selected_exist($search, 'offer_type', '0')?> ><?php echo AIN::getPhrase('homdom.all'); ?></option>
                                <option  value="1" <?=AIN::getService('homdom.helpers')->selected_exist($search, 'offer_type', '1')?>><?php echo AIN::getPhrase('homdom.sale_offers'); ?></option>
                                <option  value="2" <?=AIN::getService('homdom.helpers')->selected_exist($search, 'offer_type', '2')?>><?php echo AIN::getPhrase('homdom.rent_offers'); ?></option>
                        ...
                        <div class="add_col col_2 ">
                            <div class="search-row__cell search-row__cell--category select_city_data">
                                <select class="js-example-basic-single filter_select_items" id="property_type_id" name="property_type_id" >
                                    <option value="1" data-item="1" <?=AIN::getService('homdom.helpers')->selected_exist($search, 'property_type_id', '1')?>><?php echo AIN::getPhrase('homdom.offer_property_type_id_1'); ?></option>
                                    <option value="2" data-item="2" <?=AIN::getService('homdom.helpers')->selected_exist($search, 'property_type_id', '2')?>><?php echo AIN::getPhrase('homdom.offer_property_type_id_2'); ?></option>
                                    <option value="3" data-item="3" <?=AIN::getService('homdom.helpers')->selected_exist($search, 'property_type_id', '3')?>><?php echo AIN::getPhrase('homdom.offer_property_type_id_3'); ?></option>
                                    <option value="4" data-item="4" <?=AIN::getService('homdom.helpers')->selected_exist($search, 'property_type_id', '4')?>><?php echo AIN::getPhrase('homdom.offer_property_type_id_4'); ?></option>
                                    <option value="5" data-item="5" <?=AIN::getService('homdom.helpers')->selected_exist($search, 'property_type_id', '5')?>><?php echo AIN::getPhrase('homdom.offer_property_type_id_5'); ?></option>
                                    <option value="6" data-item="6" <?=AIN::getService('homdom.helpers')->selected_exist($search, 'property_type_id', '6')?>><?php echo AIN::getPhrase('homdom.offer_property_type_id_6'); ?></option>
                                </select>
                            </div>
                        </div>
                    </div>
...
<?php $s_room_count =  (isset($search['room_count']) and count($search['room_count'])) ? implode(',', $search['room_count']) : ""; ?>
                                <input type="text" class="count_room_text" placeholder="<?php echo AIN::getPhrase('homdom.room_count'); ?>" value="<?=$s_room_count?>" >
                            </div>
...
<?php } ?>
                    ...
                    <div class="add_col col_2">
                        <div class="all_filter_min_max">
                            <div class="filter_name add_col col_3 p_0"><?php echo AIN::getPhrase('homdom.area'); ?></div>
                            <div class="filter_m_inpt add_col col_5 p_0">
                                <div class="add_inp_number">
                                    <input type="text" name="min_area" value="<?=AIN::getService('homdom.helpers')->getValueOfInput($search, 'min_area')?>" placeholder="<?php echo AIN::getPhrase('homdom.min'); ?>" class="decimal" maxlength="12">
                                    <span class="clear_inp_val"></span>
                                </div>
                                <div class="add_inp_number">
                                    <input type="text" name="max_area" value="<?=AIN::getService('homdom.helpers')->getValueOfInput($search, 'max_area')?>" placeholder="<?php echo AIN::getPhrase('homdom.max'); ?>" class="decimal" maxlength="12">
                                    <span class="clear_inp_val"></span>
                                </div>
                            </div>
                        </div>
            ...
            <div class="add_row">
                <div class="add_col col_2 ">
                    <div class="add_col p_0">
                        <div class="all_filter_min_max">
                            <div class="filter_name add_col col_3 p_0"><?php echo AIN::getPhrase('homdom.price'); ?></div>
                            <div class="filter_m_inpt add_col col_5 p_0">
                                <div class="add_inp_number">
                                    <input type="text" name="min_price"  value="<?=AIN::getService('homdom.helpers')->getValueOfInput($search, 'min_price')?>" placeholder="<?php echo AIN::getPhrase('homdom.min'); ?>" class="decimal" maxlength="12">
                                    <span class="clear_inp_val"></span>
                                </div>
                                <div class="add_inp_number">
                                    <input type="text" name="max_price"  value="<?=AIN::getService('homdom.helpers')->getValueOfInput($search, 'max_price')?>" placeholder="<?php echo AIN::getPhrase('homdom.max'); ?>" class="decimal" maxlength="12" >
                                    <span class="clear_inp_val"></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="search-filters__row search-filters__row--locations" id="js-search-filters-row-locations">
                            <div class="search-filters__locations p_10">
                                <a data-reveal-id="js-search-locations" data-locations-tab="metro" data-animation="fade" class="search-filters__location js-search-filters-location" href="">
                                    <span class="name"><?php echo AIN::getPhrase('homdom.metro'); ?></span>
                                ...
                                <a data-reveal-id="js-search-locations" data-locations-tab="landmark" data-animation="fade" class="search-filters__location js-search-filters-location" href="" >
                                    <span class="name"><?php echo AIN::getPhrase('homdom.target'); ?></span>
                                    <span class="count"></span>
                                </a>
                            </div>
                        </div>
        ...
        <div class="search-filters__container">
            ...
            <div class="filter_footer_flx">
                <div class="add_col col_2 ">
                    ...
                    <div class="search-row__cell_inline">
                        <a class="search-filters__reset js-search-filters-reset" href="#"><?php echo AIN::getPhrase('homdom.reset'); ?></a>
                    </div>
                </div>
                <div class="add_col col_2 ">
                    <div class="search-row__cell search-row__cell--btn">
                        <button type="submit"><?php echo AIN::getPhrase('homdom.search'); ?> </button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="reveal-modal-popup">
            <div class="search-locations__city-wrap js-search-locations-city-wrap show" data-city-id="1">
                <div class="reveal-header">
                    <div class="search-locations__city"><?php echo AIN::getPhrase('homdom.baku'); ?></div>
                    <div class="search-locations__tabs js-locations-tabs">
                        <div class="search-locations__tabs_tab" data-locations-tab="region"><?php echo AIN::getPhrase('homdom.localities'); ?></div>
                        <div class="search-locations__tabs_tab" data-locations-tab="metro"><?php echo AIN::getPhrase('homdom.metros'); ?></div>
                        <div class="search-locations__tabs_tab" data-locations-tab="landmark"><?php echo AIN::getPhrase('homdom.targets'); ?></div>
                    </div>
