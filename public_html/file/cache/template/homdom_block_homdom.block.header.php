        ...
        <div class="header_center  ">
            <div class="top_icons  ">
                ...
                <div class="icons_sect  ">
                    ...
                    <a href="<?php echo AIN::getLib('url')->makeUrl('announce.add'); ?>" class="add_announce_link"><span class="link_btn_img">+</span> <span class="link_btn_name"><?php echo AIN::getPhrase('homdom.anounce_add'); ?> </span> </a>
<?php if (auth ( )): ?>
                    ...
                    <div class="profile_item">
                        ...
                        <div class="notifications-section">
                            <div class="tooltip_prf-links">
                                <a href="<?php echo AIN::getLib('url')->makeUrl('profile.favorites'); ?>" target="_self" rel="noopener noreferrer" class="">
                                    <span class="tooltp_icons "><img src="/theme/frontend/homdom/style/img/heart_title.svg" alt=""> </span>
                                    <span class="prf_earn_nm"><?php echo AIN::getPhrase('homdom.favorites'); ?> </span>
                                </a>
                                <a href="<?php echo AIN::getLib('url')->makeUrl('profile.history'); ?>" target="_self" rel="noopener noreferrer" class="">
                                    <span class="tooltp_icons "><img src="/theme/frontend/homdom/style/img/clock.svg" alt=""> </span>
                                    <span class="prf_earn_nm"><?php echo AIN::getPhrase('homdom.history'); ?> </span>
                                </a>
                                <a href="<?php echo AIN::getLib('url')->makeUrl('profile.parameters'); ?>" target="_self" rel="noopener noreferrer" class="">
                                    <span class="tooltp_icons "><img src="/theme/frontend/homdom/style/img/paramter.svg" alt=""> </span>
                                    <span class="prf_earn_nm"><?php echo AIN::getPhrase('homdom.parameters'); ?> </span>
                                </a>
                                <a href="<?php echo AIN::getLib('url')->makeUrl('auth.logout'); ?>" target="_self" rel="noopener noreferrer" class="">
                                    <span class="tooltp_icons "><img src="/theme/frontend/homdom/style/img/exit.svg?v1" alt=""> </span>
                                    <span class="prf_earn_nm prf-exit"><?php echo AIN::getPhrase('homdom.logout'); ?></span>
                                </a>
                            </div>
                        </div>
                    </div>
...
<?php else: ?>
                    <a href="<?php echo AIN::getLib('url')->makeUrl('auth.login'); ?>" class="sign_in"> <span class="link_btn_img user"> </span><span class="link_btn_name"> <?php echo AIN::getPhrase('user.login'); ?> </span>  </a>
<?php endif; ?>
...
<!--                    <li><a href="<?php echo AIN::getLib('url')->makeUrl('contact'); ?>" class=""><?php echo AIN::getPhrase('homdom.contact'); ?> </a> </li>-->
<!--                </ul>-->
            </nav>
        </div>
