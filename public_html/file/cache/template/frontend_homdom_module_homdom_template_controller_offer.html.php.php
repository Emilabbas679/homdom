...
<?php  if (date('Y-m-d h:i:s') > $offer['validity_date'])  { ?>
                    <div class="expired_alert">
                        <p><?php echo AIN::getPhrase('homdom.expired_offer'); ?></p>
                    </div>
<?php } ?>
                ...
                <div class="main_right">
                    <div class="sticker_owner">
                        <div class="sticker_date_view">
                            <div class="st_row">
                                <div class="st_col">
                                    <div class="stick_info"><?php echo AIN::getPhrase('homdom.date'); ?>: <?=AIN::getService('homdom.helpers')->CalculateDate($offer['modified_date'])?></div>
                                </div>
                                <div class="st_col">
                                    <div class="stick_info"><?php echo AIN::getPhrase('homdom.hits'); ?>: <?=$offer['hits']?> </div>
                                </div>
                            </div>
                            <div class="st_row">
...
<?php if ($offer['agency_id'] != 0) { ?>
                                <div class="st_col">
                                    <span class="stick_info"><?php echo AIN::getPhrase('homdom.agency'); ?>:</span>
                                </div>
                                <div class="st_col">
...
<?php echo AIN::getPhrase('homdom.email'); ?>:
<?php } else  ?>
<?php echo AIN::getPhrase('homdom.seller_name'); ?>:
                                    </span>
...
<?php if ($offer['user_email'] != null) { echo  $offer['user_email'];} else echo $offer['seller_name'] ?>
                        ...
                        <div class="show_number">
                            <div class="current_show_num"><?php echo AIN::getPhrase('homdom.show_number'); ?></div>
                            <div class="current_show_num_info">
                                ...
                                <div class="currnt_info"><?php echo AIN::getPhrase('homdom.sale_info_phone'); ?></div>
                            </div>
                        </div>
...
<?php if ($this->_aVars['offer']['room_count'] != 0): ?>
                                <li><span class="item_value"><?=$offer['room_count']?></span> <span class="item_name">- <?php echo AIN::getPhrase('homdom.room_count'); ?> </span> </li>
<?php endif; ?>
<?php if ($this->_aVars['offer']['flat_floor'] != 0): ?>
                                <li><span class="item_value"><?=$offer['flat_floor'].'/'.$offer['floors_total']?></span> <span class="item_name">- <?php echo AIN::getPhrase('homdom.floor'); ?> </span> </li>
<?php endif; ?>
<?php if ($this->_aVars['offer']['built_year'] != 0 && $this->_aVars['offer']['built_year'] != null): ?>
                                <li><span class="item_value"><?=$offer['built_year']?></span> <span class="item_name">- <?php echo AIN::getPhrase('homdom.built_year'); ?> </span> </li>
<?php endif; ?>
<?php if ($this->_aVars['offer']['ceiling_height'] != 0): ?>
                                <li><span class="item_value"><?=$offer['ceiling_height']?> m </span> <span class="item_name">- <?php echo AIN::getPhrase('homdom.ceiling_height'); ?> </span> </li>
<?php endif; ?>

<?php if ($this->_aVars['offer']['area'] != 0): ?>
                                <li><span class="item_value"><?=$offer['area']?>  <?php if ($offer['property_type_id'] != 3) { ?> m<sup>2</sup> <?php } else { echo AIN::getPhrase("homdom.ar");}?> </span> <span class="item_name">- <?php echo AIN::getPhrase('homdom.area'); ?> </span> </li>
<?php endif; ?>

<?php if(isset($offer['room_space']['living'])) { ?>
                                    <li><span class="item_value"><?=$offer['room_space']['living']?> m<sup>2</sup></span> <span class="item_name">- <?php echo AIN::getPhrase('homdom.living'); ?> </span> </li>
<?php } ?>

<?php if(isset($offer['room_space']['kitchen'])) { ?>
                                    <li><span class="item_value"><?=$offer['room_space']['kitchen']?> m<sup>2</sup></span> <span class="item_name">- <?php echo AIN::getPhrase('homdom.kitchen'); ?> </span> </li>
<?php } ?>
...
<?php if(isset($offer['room_space']['balcony']) and $offer['room_space']['balcony'] != '' and $offer['room_space']['balcony'] != 0) { ?>
                                    <li><span class="item_value"><?=$offer['room_space']['balcony']?> m<sup>2</sup></span> <span class="item_name">- <?php echo AIN::getPhrase('homdom.balcony'); ?> </span> </li>
<?php } ?>
                            </ul>
                            </div>
                            <div class="show_hide_btn">
                                <div class="show_table_full"><?php echo AIN::getPhrase('homdom.more'); ?></div>
                                <div class="hide_table_full"><?php echo AIN::getPhrase('homdom.redo'); ?></div>
                            </div>
...
<?php if (( $this->_aVars['offer']['property_type_id'] == 1 || $this->_aVars['offer']['property_type_id'] == 2 ) && $this->_aVars['offer']['offer_type'] == 1): ?>
                                        <tr>
                                            <td><span class="item_value"><?php echo AIN::getPhrase('homdom.bill_of_sale'); ?> </span> </td>
                                            <td><span class="item_name">- <?=AIN::getPhrase('homdom.bill_of_sale_'.$offer['bill_of_sale'])?> </span></td>
                                        </tr>
<?php endif; ?>

<?php if ($this->_aVars['offer']['haggle'] == 1): ?>
                                    <tr>
                                        <td><span class="item_value"><?php echo AIN::getPhrase('homdom.haggle'); ?> </span> </td>
                                        <td><span class="item_name">- <?=AIN::getPhrase('homdom.haggle_'.$offer['haggle'])?> </span></td>
                                    </tr>
<?php endif; ?>
<?php if ($this->_aVars['offer']['mortgage'] == 1): ?>
                                    <tr>
                                        <td><span class="item_value"><?php echo AIN::getPhrase('homdom.mortgage'); ?> </span> </td>
                                        <td><span class="item_name">- <?=AIN::getPhrase('homdom.mortgage_'.$offer['mortgage'])?> </span></td>
                                    </tr>
<?php endif; ?>

<?php if ($this->_aVars['offer']['property_type_id'] == 2 || $this->_aVars['offer']['property_type_id'] == 4): ?>
<?php if ($this->_aVars['offer']['material'] != null && $this->_aVars['offer']['material'] != 0): ?>
                                    <tr>
                                        <td><span class="item_value"><?php echo AIN::getPhrase('homdom.material'); ?> </span> </td>
                                        <td>
...
<?php if ($this->_aVars['offer']['property_type_id'] == 3): ?>
                                    <tr>
                                        <td><span class="item_value"><?php echo AIN::getPhrase('homdom.field_type'); ?> </span> </td>
                                        <td>
                                            <span class="item_name">-<?=AIN::getPhrase('homdom.field_type_'.$offer['field_type'])?></span>
                                        </td>
                                    </tr>
<?php endif; ?>
<?php if ($this->_aVars['offer']['property_type_id'] == 5): ?>
                                    <tr>
                                        <td><span class="item_value"><?php echo AIN::getPhrase('homdom.building_exit'); ?> </span> </td>
                                        <td>
                                            <span class="item_name">-<?=AIN::getPhrase('homdom.building_exit_'.$offer['building_exit'])?></span>
                                        </td>
                                    </tr>
<?php endif; ?>
<?php if ($this->_aVars['offer']['property_type_id'] == 6): ?>
                                    <tr>
                                        <td><span class="item_value"><?php echo AIN::getPhrase('homdom.building_entrance'); ?> </span> </td>
                                        <td>
...
<?php if ($this->_aVars['offer']['property_type_id'] == 6): ?>
                                    <tr>
                                        <td><span class="item_value"><?php echo AIN::getPhrase('homdom.commercial_type'); ?> </span> </td>
                                        <td>
...
<?php if ($this->_aVars['offer']['property_type_id'] == 4): ?>
<?php if ($this->_aVars['offer']['building_name'] != null): ?>
                                        <tr>
                                            <td><span class="item_value"><?php echo AIN::getPhrase('homdom.building_name'); ?> </span> </td>
                                            <td>
...
<?php if ($this->_aVars['offer']['property_type_id'] == 4): ?>
                                    <tr>
                                        <td><span class="item_value"><?php echo AIN::getPhrase('homdom.garage_type'); ?> </span> </td>
                                        <td>
...
<?php if ($this->_aVars['offer']['property_type_id'] == 4): ?>
                                    <tr>
                                        <td><span class="item_value"><?php echo AIN::getPhrase('homdom.garage_status'); ?> </span> </td>
                                        <td>
...
<?php if ($this->_aVars['offer']['property_type_id'] == 1): ?>
<?php if ($this->_aVars['offer']['building_name'] != null): ?>
                                        <tr>
                                            <td><span class="item_value"><?php echo AIN::getPhrase('homdom.building'); ?> </span> </td>
                                            <td>
                                                <span class="item_name">-
<?php if ($this->_aVars['offer']['building_id'] == 0): ?>
<?php echo $this->_aVars['offer']['building_name']; ?>
<?php else: ?>
<?php echo $this->_aVars['offer']['b_name']; ?>
<?php endif; ?>
                                                </span>
                                            </td>
                                        </tr>
...
<?php if ($this->_aVars['offer']['property_type_id'] == 1 || $this->_aVars['offer']['property_type_id'] == 2): ?>
<?php if ($this->_aVars['offer']['parking'] != 0): ?>
                                            <tr>
                                                <td><span class="item_value"><?php echo AIN::getPhrase('homdom.parking'); ?> </span> </td>
                                                <td><span class="item_name">- <?=AIN::getPhrase('homdom.parking_'.$offer['parking'])?> </span></td>
                                            </tr>
<?php endif; ?>
<?php endif; ?>

<?php if ($this->_aVars['offer']['property_type_id'] != 3 && $this->_aVars['offer']['property_type_id'] != 4 && $this->_aVars['offer']['property_type_id'] != 6): ?>
<?php if ($this->_aVars['offer']['source_id'] == null): ?>
                                            <tr>
                                                <td><span class="item_value"><?php echo AIN::getPhrase('homdom.quality'); ?> </span> </td>
...
<?php if ($this->_aVars['offer']['property_type_id'] == 1 || $this->_aVars['offer']['property_type_id'] == 2): ?>
<?php if (count ( $this->_aVars['offer']['window_view'] ) > 0): ?>
                                    <tr>
                                        <td><span class="item_value"><?php echo AIN::getPhrase('homdom.window_view'); ?> </span> </td>
                                        <td>
                                            <span class="item_name">-
...
<?php if ($this->_aVars['offer']['property_type_id'] == 1): ?>
<?php if (count ( $this->_aVars['offer']['lift'] ) > 0): ?>

                                    <tr>
                                        <td><span class="item_value"><?php echo AIN::getPhrase('homdom.lift'); ?> </span> </td>
                                        <td>
                                            <span class="item_name">-
...
<?php if ($this->_aVars['offer']['property_type_id'] == 1 || $this->_aVars['offer']['property_type_id'] == 2): ?>
<?php if ($this->_aVars['offer']['sanitary'] != null): ?>
                                        <tr>
                                            <td><span class="item_value"><?php echo AIN::getPhrase('homdom.sanitary'); ?> </span> </td>
                                            <td>
...
<?php echo AIN::getPhrase('homdom.similar_offers'); ?>
                </div>
            </div>
            <div class="wrap_body">
                <div class="wrap_owl">
    ...
    <div class="section_wrap wrap_interest">
        <div class="main_center">
            <div class="setcion_interset">
                <div class="house_title">
                    <div class="title_inner">
<?php echo AIN::getPhrase('homdom.interesting_offers_for_you'); ?>
                    </div>
                </div>
                <div class="sect_like_announce">
