...
<div class="add_col col_1 ">
    <div class="add_col col_4">
        <div class="add_litle_title "><?php echo AIN::getPhrase('homdom.building_type'); ?>  </div>
    </div>
...
<div class="add_col col_1 ">
    <div class="add_col col_4">
        <div class="add_litle_title"><?php echo AIN::getPhrase('homdom.flat_floor'); ?> </div>
    </div>
    <div class="add_col col_6">
            ...
            <div class="all_filter_min_max">
                <div class="filter_m_inpt add_col p_0">
                    <div class="add_inp_number">
                        <input type="text"  name="flat_floor[min]" value="<?=AIN::getService('homdom.helpers')->getValueOfArray($search,'flat_floor', 'min')?>" placeholder="<?php echo AIN::getPhrase('homdom.min'); ?>" class="integer_num" maxlength="3">
                        <span class="clear_inp_val"></span>
                    </div>
                    <div class="add_inp_number">
                        <input type="text" name="flat_floor[max]" value="<?=AIN::getService('homdom.helpers')->getValueOfArray($search,'flat_floor', 'max')?>" placeholder="<?php echo AIN::getPhrase('homdom.max'); ?>" class="integer_num" maxlength="3" >
                        <span class="clear_inp_val"></span>
                    </div>
                </div>
            </div>
        ...
        <div class="add_col col_6">
            <div class="add_check_items">
                <label class="add_check">
                    ...
                    <span><?php echo AIN::getPhrase('homdom.not_first'); ?> </span>
                </label>
            </div>
            <div class="add_check_items">
                <label class="add_check">
                    ...
                    <span><?php echo AIN::getPhrase('homdom.not_last'); ?></span>
                </label>
            </div>
            <div class="add_check_items">
                <label class="add_check">
                    ...
                    <span><?php echo AIN::getPhrase('homdom.last'); ?></span>
                </label>
            </div>
        </div>
    </div>
...
<div class="add_col col_1 " >
    <div class="add_col col_4">
        <div class="add_litle_title"><?php echo AIN::getPhrase('homdom.quality'); ?> </div>
    </div>
    <div class="add_col col_6">
<?php for ($i=0; $i<5; $i++) { ?>
            <div class="add_check_items">
...
<div class="add_col col_1 " >
    <div class="add_col col_4">
        <div class="add_litle_title"><?php echo AIN::getPhrase('homdom.kitchen_minimum'); ?> </div>
    </div>
    <div class="add_col col_6">
...
<div class="add_col col_1 " >
    <div class="add_col col_4">
        <div class="add_litle_title"><?php echo AIN::getPhrase('homdom.utilities_include'); ?> </div>
    </div>
    <div class="add_col col_6">
<?php for ($i=0;$i<=1; $i++ ) { ?>
            <div class="add_check_items oneChecked">
...
<div class="add_col col_1 ">
    <div class="add_col col_4">
        <div class="add_litle_title"><?php echo AIN::getPhrase('homdom.ceiling_height'); ?></div>
    </div>
    <div class="add_col col_6">
...
<div class="add_col col_1 " >
    <div class="add_col col_4">
        <div class="add_litle_title"><?php echo AIN::getPhrase('homdom.balcony'); ?> </div>
    </div>
    <div class="add_col col_6">
<?php for ($i=0; $i<=2;$i++) { ?>
            <div class="add_check_items oneChecked">
...
<div class="add_col col_1 ">
    <div class="add_col col_4">
        <div class="add_litle_title"><?php echo AIN::getPhrase('homdom.window_view'); ?> </div>
    </div>
    <div class="add_col col_6">
<?php for ($i=1; $i<=2; $i++) { ?>
            <div class="add_check_items">
...
<div class="add_col col_1 " >
    <div class="add_col col_4">
        <div class="add_litle_title"><?php echo AIN::getPhrase('homdom.sanitary'); ?> </div>
    </div>
    <div class="add_col col_6">
<?php for ($i=1;$i<=3; $i++) { ?>
            <div class="add_check_items oneChecked">
...
<div class="add_col col_1 "  >
    <div class="add_col col_4">
        <div class="add_litle_title"><?php echo AIN::getPhrase('homdom.building_name'); ?> </div>
    </div>
    <div class="add_col col_6">
...
<?php } } ?>
                ...
                <div class="alert alert-danger alert-block">
                    ...
                    <span><?php echo AIN::getPhrase('homdom.enter'); ?></span>
                </div>
...
<div class="add_col col_1 " >
    <div class="add_col col_4">
        <div class="add_litle_title"><?php echo AIN::getPhrase('homdom.total_floor'); ?></div>
    </div>
    <div class="add_col col_6">
        <div class="add_col col_4 p_0">
            <div class="all_filter_min_max">
                <div class="filter_m_inpt add_col p_0">
                    <div class="add_inp_number">
                        <input type="text" name="floors_total_min" value="<?=AIN::getService('homdom.helpers')->getValueOfInput($search, 'floors_total_min')?>" placeholder="<?php echo AIN::getPhrase('homdom.min'); ?>" class="integer_num" maxlength="3">
                        <span class="clear_inp_val"></span>
                    </div>
                    <div class="add_inp_number">
                        <input type="text" name="floors_total_max" value="<?=AIN::getService('homdom.helpers')->getValueOfInput($search, 'floors_total_max')?>" placeholder="<?php echo AIN::getPhrase('homdom.max'); ?>" class="integer_num" maxlength="3"  >
                        <span class="clear_inp_val"></span>
                    </div>
                </div>
            </div>
...
<div class="add_col col_1 " >
    <div class="add_col col_4">
        <div class="add_litle_title"><?php echo AIN::getPhrase('homdom.built_year'); ?> </div>
    </div>
    <div class="add_col col_6">
        <div class="add_col col_4 p_0">
            <div class="all_filter_min_max">
                <div class="filter_m_inpt add_col p_0">
                    <div class="add_inp_number">
                        <input type="text" name="built_year_min" value="<?=AIN::getService('homdom.helpers')->getValueOfInput($search, 'built_year_min')?>" placeholder="<?php echo AIN::getPhrase('homdom.min'); ?>" class="integer_num" maxlength="4">
                        <span class="clear_inp_val"></span>
                    </div>
                    <div class="add_inp_number">
                        <input type="text" name="built_year_max" value="<?=AIN::getService('homdom.helpers')->getValueOfInput($search, 'built_year_max')?>" placeholder="<?php echo AIN::getPhrase('homdom.min'); ?>" class="integer_num" maxlength="4" >
                        <span class="clear_inp_val"></span>
                    </div>
                </div>
            </div>
        ...
        <label class="add_inp_check_static">
            ...
            <span><?php echo AIN::getPhrase('homdom.not_delivery'); ?></span>
        </label>
    </div>
</div>
<div class="add_col col_1 " >
    <div class="add_col col_4">
        <div class="add_litle_title"> <?php echo AIN::getPhrase('homdom.parking'); ?></div>
    </div>
    <div class="add_col col_6">
<?php for ($i =0; $i<=3; $i++) { ?>
            <div class="add_check_items">
...
<div class="add_col col_1 " >
    <div class="add_col col_4">
        <div class="add_litle_title"><?php echo AIN::getPhrase('homdom.lift'); ?> </div>
    </div>
    <div class="add_col col_6">
<?php for ($i = 2; $i<=3; $i++) { ?>
            <div class="add_check_items oneChecked">
...
<div class="add_col col_1 " >
    <div class="add_col col_4">
        <div class="add_litle_title"><?php echo AIN::getPhrase('homdom.imagine'); ?> </div>
    </div>
    <div class="add_col col_6">
        <div class="add_check_items">
            <label class="add_check">
                ...
                <span><?php echo AIN::getPhrase('homdom.image'); ?> </span>
            </label>
        </div>
        <div class="add_check_items">
            <label class="add_check">
...
<div class="add_col col_1 " >
    <div class="add_col col_4">
        <div class="add_litle_title"><?php echo AIN::getPhrase('homdom.bill_of_sale'); ?></div>
    </div>
    <div class="add_col col_6">
<?php for ($i =0; $i<=1; $i++) { ?>
            <div class="add_check_items oneChecked">
...
<div class="add_col col_1 " >
    <div class="add_col col_4">
        <div class="add_litle_title"><?php echo AIN::getPhrase('homdom.mortgage'); ?> </div>
    </div>
    <div class="add_col col_6">
<?php for ($i =0; $i<=1; $i++) { ?>
            <div class="add_check_items oneChecked">
...
<div class="add_col col_1 " >
    <div class="add_col col_4">
        <div class="add_litle_title"><?php echo AIN::getPhrase('homdom.seller_type'); ?> </div>
    </div>
    <div class="add_col col_6">
<?php for ($i =0; $i<=1; $i++) { ?>
            <div class="add_check_items oneChecked">
