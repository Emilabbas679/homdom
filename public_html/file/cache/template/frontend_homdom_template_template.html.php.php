...
<div class="page">
    <?php
						AIN::getLib('template')->getBuiltFile('homdom.block.header');
						?>
<?php if (!$this->bIsSample): ?><div id="site_content"><?php AIN::getLib('module')->getControllerTemplate(); ?></div><?php endif; ?>
    <?php
						AIN::getLib('template')->getBuiltFile('homdom.block.footer');
						?>
    <!-- POPUP modal  -->
    <?php
						AIN::getLib('template')->getBuiltFile('homdom.block.popup');
						?>
    <!-- POPUP modal  -->
</div>
