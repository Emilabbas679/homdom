...
class homdom_component_block_offersPage extends AIN_Component
{
    public function process()
    {
        ...
        $url_parses = explode('/', $url['path']);
        $url_parse_3 = '';
        $url_parse_2 = '';
        if (isset($url_parses[2]))
            $url_parse_2 = $url_parses[2];
        if (isset($url_parses[3]))
            $url_parse_3 = $url_parses[3];
